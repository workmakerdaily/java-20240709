...
//		System.out.println(numbers3[99]);
		...
		System.out.println(statement.equals(" My name is loki ")); // true
		System.out.println(statement.compareTo(" My name is loki ")); // 0
		
		// 3. 문자열 길이
		// length() : 문자열의 길이를 반환
		System.out.println(statement.length()); // 17
		...
		System.out.println(statement.trim()); //My name is loki
		
		// 5. 문자열 찾기
		// indexOf(문자열) : 찾고자하는 문자열의 처음 찾은 위치 인덱스 번호를 반환
		...
		System.out.println(statement.indexOf("사자")); // -1
		System.out.println(statement.lastIndexOf("기린")); // 45
		System.out.println(statement.lastIndexOf("사자")); // -1
