...
// AreaCalculation, CircumferenceCalculation를 확장함
}
...
interface Statement {
	String greet = "안녕하세요"; // 항상 "안녕하세요"만 호출할 수 있도록 함
}
...
//		AreaCalculation.PI = 10; 불가능
		
		MyCaculation instance = new MyCaculation();
		System.out.println(instance.getCircleArea(10)); // 314.0
		System.out.println(instance.getCircleCircumference(10)); // 62.800000000000004
		
		System.out.println(Statement.greet); // 안녕하세요
	}
}
